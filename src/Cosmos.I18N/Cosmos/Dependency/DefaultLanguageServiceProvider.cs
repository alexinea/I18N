...
{
    public class DefaultLanguageServiceProvider : ILanguageServiceProvider
    {
        private readonly ITranslationManager _translationManager;
        private readonly TranslationProcessor _translationProcessor;

        /// <summary>
        /// Create a new instance of <see cref="DefaultLanguageServiceProvider"/>.
        /// </summary>
        /// <param name="manager"></param>
        /// <param name="processor"></param>
        public DefaultLanguageServiceProvider(ITranslationManager manager, TranslationProcessor processor)
        {
