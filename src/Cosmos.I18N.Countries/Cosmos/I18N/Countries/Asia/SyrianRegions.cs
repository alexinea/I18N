...
namespace Cosmos.I18N.Countries.Asia
{
    ...
    public static class SyrianRegions
    {
        ...
        public enum EnumValues
        {
            ...
            /// Damascus
            /// </summary>
            [AliasInShort("DI")] Damascus,

            /// <summary>
            /// Daraa
            /// </summary>
            [AliasInShort("DR")] Daraa,

            /// <summary>
            /// Deir ez-Zor
            /// </summary>
            [AliasInShort("DY")] DeirEzZor,

            /// <summary>
            /// Al-Hasakah
            /// </summary>
            [AliasInShort("HA")] AlHasakah,

            /// <summary>
            /// Homs
            /// </summary>
            [AliasInShort("HI")] Homs,

            /// <summary>
            /// Aleppo
            /// </summary>
            [AliasInShort("HL")] Aleppo,

            /// <summary>
            /// Hama
            /// </summary>
            [AliasInShort("HM")] Hama,

            /// <summary>
            /// Idlib
            /// </summary>
            [AliasInShort("ID")] Idlib,

            /// <summary>
            /// Latakia
            /// </summary>
            [AliasInShort("LA")] Latakia,

            /// <summary>
            /// Quneitra
            /// </summary>
            [AliasInShort("QU")] Quneitra,

            /// <summary>
            /// Ar-Raqqah
            /// </summary>
            [AliasInShort("RA")] ArRaqqah,

            /// <summary>
            /// Rif Dimashq
            /// </summary>
            [AliasInShort("RD")] RifDimashq,

            /// <summary>
            /// As-Suwayda
            /// </summary>
            [AliasInShort("SU")] AsSuwayda,

            /// <summary>
            /// Tartus
            /// </summary>
            [AliasInShort("TA")] Tartus,
